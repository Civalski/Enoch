...
export function ProjectAdminControls({ projectId, title }: Props) {
  return (
    <div
    ...
    >
      <Link
        href={`/app/projetos/${projectId}/editar`}
      ...
      <DeleteProjectButton projectId={projectId} title={title} variant="icon" />
    </div>
  );
}
